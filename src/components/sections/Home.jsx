...
function SliderContent({headerTitle, headerContent}) {
  return (
    <div className="text-[32px] relative z-1 flex flex-col gap-[115px] justify-start pt-[200px] items-center min-h-screen font-inter">
      <div>
        <h1 className="text-[64px] px-[44px] text-shadow-orange text-orange-main font-bold text-center">
      ...
      <div className="max-w-[900px] bg-white rounded-[60px] pb-[55px]">
        <p className="w-full py-[60px] px-[44px] rounded-[60px] bg-orange-main text-center">
        ...
        <div className="text-orange-main pt-[60px] pb-5 px-[44px] flex flex-col justify-center items-center gap-[60px]">
          <p className="text-center max-w-[800px] text-[40px] mx-auto">
          ...
          <div className="flex justify-evenly w-full font-bold">
            <button className="bg-orange-main text-white rounded-full flex-shrink-0 py-5 px-20">
              Learn Now
            </button>
            <button className="box-border text-orange-main border-[3px] border-orange-main rounded-full flex-shrink-0 py-5 px-20">
              Donate Now
            </button>
          </div>
        </div>
