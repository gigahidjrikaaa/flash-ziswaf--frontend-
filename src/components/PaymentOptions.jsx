    ...
    <div className="fixed flex justify-center items-center top-0 left-0 w-full h-screen z-[100]">
      ...
      <div className="bg-white relative z-[50] rounded-[54px] font-inter text-orange-main px-[50px] md:px-[60px] xl:px-[72px] py-[45px] md:py-[50px] xl:py-[52px] w-[90%] sm:max-w-[500px] md:max-w-[700px] lg:max-w-[900px] xl:max-w-[1190px]">
        ...
        <div className="flex justify-center items-center mt-[30px] mb-[60px] gap-8">
          ...
          <Swiper className="">
            <SwiperSlide>
              <div className="flex flex-col xl:flex-row gap-[55px] justify-center items-center">
                <Image
                  src={RumahZIS}
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-[20px] xl:text-[25px] text-justify">
                      Donates to the people of Yogyakarta. Focuses mainly on
                      orphans, beggars, and poor students.
                  </p>
          ...
          <svg
            ...
            viewBox="0 0 59 68"
            fill="none"
            className="rotate-180 w-[40px] xl:w-[59px]"
          >
            <path
              d="M-1.70474e-06 34L58.5 0.225004L58.5 67.775L-1.70474e-06 34Z"
              fill="#DC7700"
        ...
        <button className="w-full bg-orange-main text-white font-bold rounded-full py-3 text-[25px] md:text-[32px] xl:text-[40px]">
            Donate
        </button>
      </div>
    </div>
